            ...
            <ScrollView
                ...
                <SafeAreaView style={{ backgroundColor: colors.white }}>
                    ...
                    <View style={style.detailsWrapper}>
                        ...
                        <Text style={style.description}>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</Text>
                    </View>
                    ...
                    <View style={[style.boxWrapper, { marginBottom: 15 }]}>
                        ...
                        <TouchableOpacity onPress={() => { setQuantity(prev => prev - 1) }}>
                            <Image style={{ marginHorizontal: 11 }} source={images.minus} />
                        </TouchableOpacity>

                        <Text style={style.quantity}>{quantity}</Text>

                        <TouchableOpacity onPress={() => { setQuantity(prev => prev + 1) }}>
                            <Image style={{ marginHorizontal: 11 }} source={images.plus} />
                        </TouchableOpacity>
                    </View>

                    <View style={[style.boxWrapper, { marginBottom: 42 }]}>
                        <View style={style.personalizationWrapper}>
                            <Text style={style.personalizationTitle}>Add Personalization</Text>
                            <Text style={style.personalizationDesc}>Star shapes on right side of sticker.</Text>
                        </View>
                    </View>
